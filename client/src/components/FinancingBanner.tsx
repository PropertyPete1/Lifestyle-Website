 ...
 *
 * Single source of truth for the 3.99% claim so the rate figure always renders
  ...
  return (
    <div className={`border border-gold/40 bg-gold/5 px-6 py-5 text-left ${className}`}>
      <p className="text-sm text-foreground/90">
        Ask us about builder incentive buydowns — we've gotten clients mortgage rates as low as{" "}
        <span className="text-gold font-medium">3.99%</span> since 2021.
      </p>
      <p className="mt-2 text-[10px] leading-relaxed text-muted-foreground">
        Mortgage rate shown reflects past builder-incentive buydowns obtained for specific clients and is
