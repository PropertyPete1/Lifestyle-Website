...
const PILLARS = [
  { title: "Warm & Hot Transfer Leads", body: "Our City Finder, valuation requests, and Get Started pipeline deliver qualified buyers and sellers directly to the team. Lease commissions have run up to $6,000 on a single deal." },
