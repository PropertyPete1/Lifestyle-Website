...
async function run() {
  ...
  // ---- Testimonials (migrated from current site) ----
  await db.execute(`DELETE FROM testimonials`);
  const testimonials = [
    ["Steven is an excellent and professional Realtor. He helped my fiance and I find a rental property almost immediately after moving to Austin. He was very flexible, knowledgeable, and honest in helping with our search. He helped us come up with precise criteria of what we were looking for and took us around to a multitude of properties with no delay. He quickly and efficiently responded to emails, phone calls, and questions.", "Buyer", "Google"],
    ["There are a lot of good real estate agents in Austin, but in my view, none possess the qualities that Steven has. First, he's incredibly responsive. His replies never take more than a few minutes and I have grown to count on him to be looking out for my needs at every moment. Steven has also proven to me that he puts his clients first.", "Brett O.", "Google"],
    ["I cannot say enough about how great Steven is! He listened to what I needed for a rental and put together a great list. When we went to look, he was looking at the property with my best interest in mind, and if he noticed something wrong, he pointed it out. I have never encountered this level of honesty in a realtor. He was also very kind and an overall great person!", "Buyer", "Google"],
    ["I've had the pleasure of working with Steven more than once. Aside from being professional and personable, he is truly an expert negotiator. He's extremely knowledgeable, provides exceptional guidance throughout the buying process, and is well-connected. Most importantly, you'll soon learn that he truly cares and is your advocate every step of the way. I wouldn't buy or sell without him!", "Buyer & Seller", "Zillow"],
    ["Our last purchase was the 3rd time working with Steven. He was on the doorstep the day it went live. We had the keys weeks later after a competitive negotiation. Great to work with and gets it done.", "Buyer", "Zillow"],
    ["Steven has been my Realtor for many years across multiple transactions. He has always acted in my best interest and is one of the most impressive negotiators I've ever worked with. He's offered advice from rental management to remodeling and has always been the resource I go to when I have a real estate-related question. I highly recommend them to prospective buyers, sellers, and especially investors.", "Andrew L.", "Zillow"],
  ];
