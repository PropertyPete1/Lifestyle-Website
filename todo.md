...
- [ ] Manus: pull + checkpoint, then confirm the entrance on a real first visit (open in a fresh tab / private window — the session flag means a reload will correctly show the settled state instead)
