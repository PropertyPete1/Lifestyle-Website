...
- [ ] Deploy, verify with a facebookexternalhit user-agent fetch on the live domain, confirm the image URL resolves publicly, and report the final og:image URL
