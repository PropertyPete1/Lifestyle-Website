...
- [ ] Verify live that /links loads clean with no interruption, and that exit intent still works elsewhere
- [ ] Report where else the modal mounts (per Peter's request) without removing it there
