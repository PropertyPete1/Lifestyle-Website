...
- [x] Final live state confirmed: all 12 tags served to facebookexternalhit; /join/ canonicalises to https://lifestyledesignrealty.com/join; homepage, /convince, /city-finder, /lease all keep their own titles. 581 tests passing, pushed to GitHub main (c08e582)
